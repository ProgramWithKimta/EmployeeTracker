...
// code below allows the script to wait for connection to database before running the rest of the code
await connectToDb();
...
// ADD BELOW TO GET PROMPTS TO SHOW UP ON THE COMMAND LINE
