...
// add employee
export const addEmployee = async (first_name, last_name, role_id, manager_id)=> {const results = await pool.query(`INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ($1, $1, $3, $4) RETURNING *`, [first_name, last_name, role_id, manager_id]);
    return results.rows[0];
};
